...
def get_current_weather(weather_json, units):
    ...
    current_weather = {
        ...
        "humidity": str(round(weather_json["main"]["humidity"], 1)) + "%",
    ...
    if units == "metric":
        ...
        current_weather["pressure"] = (
            str(round(weather_json["main"]["pressure"], 1)) + " mb"
        )
        ...
        current_weather["feels_like"] = (
            str(round(weather_json["main"]["feels_like"], 1)) + "°F"
        )
        current_weather["pressure"] = (
            str(round(weather_json["main"]["pressure"] * 0.0145038, 1)) + " Pa"
        )
        current_weather["visibility"] = (
        ...
        current_weather["wind_speed"] = (
            str(round(weather_json["wind"]["speed"] * 0.621371, 1)) + " mi/h"
        )

    return current_weather


def get_forecast(forecast_json, units):
